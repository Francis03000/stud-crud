...
<body>
    ...
    <div>
        ...
        CURRENT SUBJECTS:
        <form action="process/delete-student-subject.php" method="post">
            ...
            <table border="1">
                ...
                <tbody>
                    <?php 
                    $sql="SELECT student_subject.subject_id,subject.subject_code,subject.subject_description  FROM student_subject LEFT JOIN subject on student_subject.subject_id = subject.id WHERE student_id = '$id'";
                    $result = $conn->query($sql);
        ...
        AVAILABLE SUBJECTS:
        <form action="process/add-student-subect.php" method="post">
